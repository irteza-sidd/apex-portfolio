...
export const FooterNavigationSection = () => {
    return (<footer className="flex flex-col w-full items-center gap-[60px] px-[150px] py-20 relative bg-neutral-950 overflow-hidden">
      {/* Decorative top-right image */}
      <img className="absolute top-0 right-0 w-[311px] h-[280px] pointer-events-none" alt="Group" src="/group-1597883015.png"/>
        ...
        <div className="inline-flex flex-col items-start gap-12 relative self-stretch">
          <div className="inline-flex flex-col items-start gap-6 relative flex-1">
            <div className="inline-flex flex-col items-start justify-between relative flex-1">
              <img className="relative w-[202.67px] h-[76px]" alt="Frame" src="/frame-1321325375.png"/>
        ...
        <div className="inline-flex items-start gap-8 relative">
          ...
          <nav className="flex flex-col w-[281px] items-start gap-6 relative">
            ...
            <ul className="flex flex-col items-start gap-0.5 relative self-stretch w-full">
              {quickLinks.map((link) => (<li key={link} className="relative flex items-center self-stretch font-paragraph-xsmall font-[number:var(--paragraph-xsmall-font-weight)] text-[#d8d8d8] text-[length:var(--paragraph-xsmall-font-size)] tracking-[var(--paragraph-xsmall-letter-spacing)] leading-[var(--paragraph-xsmall-line-height)] [font-style:var(--paragraph-xsmall-font-style)] cursor-pointer hover:text-white transition-colors">
                  {link}
                </li>))}
            </ul>
          </nav>
          ...
          <nav className="flex flex-col w-[281px] items-start gap-6 relative">
            ...
            <ul className="flex flex-col items-start gap-0.5 relative self-stretch w-full">
              {insightsLinks.map((link) => (<li key={link} className="relative flex items-center self-stretch font-paragraph-xsmall font-[number:var(--paragraph-xsmall-font-weight)] text-[#d8d8d8] text-[length:var(--paragraph-xsmall-font-size)] tracking-[var(--paragraph-xsmall-letter-spacing)] leading-[var(--paragraph-xsmall-line-height)] [font-style:var(--paragraph-xsmall-font-style)] cursor-pointer hover:text-white transition-colors">
                  {link}
                </li>))}
            </ul>
          </nav>
          ...
          <nav className="flex flex-col w-[281px] items-start gap-6 relative">
            ...
            <ul className="flex flex-col items-start gap-0.5 relative self-stretch w-full">
              {servicesLinks.map((service) => (<li key={service} className="relative flex items-center w-fit font-paragraph-xsmall font-[number:var(--paragraph-xsmall-font-weight)] text-[#d8d8d8] text-[length:var(--paragraph-xsmall-font-size)] tracking-[var(--paragraph-xsmall-letter-spacing)] leading-[var(--paragraph-xsmall-line-height)] whitespace-nowrap [font-style:var(--paragraph-xsmall-font-style)] cursor-pointer hover:text-white transition-colors">
                  {service}
                </li>))}
            </ul>
          </nav>
      ...
      <div className="flex flex-col items-start gap-6 relative self-stretch w-full">
        ...
        <div className="flex items-center gap-6 relative w-full">
          {officeLocations.map((office) => (<Card key={office.name} className="flex flex-col flex-1 h-[348px] items-start justify-between p-12 relative bg-[#202020] rounded-2xl overflow-hidden border-0">
              <CardContent className="flex flex-col items-start justify-between h-full w-full p-0">
                {/* Background decorative image */}
                <img className={office.bgImageClass} alt={office.bgImageAlt} src={office.bgImageSrc}/>
                ...
                <div className="inline-flex items-center justify-center gap-2.5 relative z-10">
                  <img className={`relative ${office.flagWidth} ${office.flagHeight}`} alt={office.flagAlt} src={office.flagSrc}/>
          ...
          <div className="flex flex-col items-center justify-center gap-10 px-[50px] py-6 relative self-stretch w-full rounded-xl border border-solid border-[#383838] bg-[linear-gradient(180deg,rgba(16,16,16,1)_0%,rgba(32,32,32,1)_100%)]">
            <div className="flex items-center justify-between relative self-stretch w-full">
              ...
              <div className="inline-flex items-center gap-[18px] relative self-stretch">
                <img className="relative w-[53px] h-[53px]" alt="Fi" src="/fi-2623002.svg"/>
              ...
              {/* Social media icons */}
              <img className="relative flex-[0_0_auto]" alt="Frame" src="/frame-2095586050.svg"/>
            </div>
          </div>
