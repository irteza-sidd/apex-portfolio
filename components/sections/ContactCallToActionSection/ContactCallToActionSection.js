...
export const ContactCallToActionSection = () => {
    return (<section className="flex w-full items-start justify-center bg-neutral-950 py-20 px-[340px]">
      <div className="relative flex flex-col w-full max-w-[1352px] items-center px-[150px] py-[100px] bg-neutral-950 rounded-[34px] overflow-hidden" style={{
            border: "1px solid transparent",
            backgroundClip: "padding-box",
            boxShadow: "inset 0 0 0 1px transparent",
            background: "linear-gradient(#0a0a0a, #0a0a0a) padding-box, linear-gradient(180deg, rgba(56,56,56,1) 0%, rgba(10,10,10,1) 100%) border-box",
            borderWidth: "1px",
            borderStyle: "solid",
            borderColor: "transparent",
        }}>
        {/* Background ellipse decoration */}
        <img className="absolute top-[403px] left-[calc(50%_-_766px)] w-[1532px] h-[659px] pointer-events-none" alt="Ellipse" src="/ellipse-21881.svg"/>

        {/* Background pattern decoration */}
        <img className="absolute top-[calc(50%_-_321px)] left-[calc(50%_-_676px)] w-[1352px] h-[642px] pointer-events-none" alt="Pattern" src="/pattern.svg"/>
        ...
        <div className="flex flex-col w-full max-w-[894px] items-center gap-[60px] relative z-10">
          ...
          <div className="flex flex-col items-center justify-center gap-3.5 w-full">
            {/* Badge pill */}
            <div className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-[6000px] overflow-hidden relative" style={{
            background: "linear-gradient(180deg, rgba(10,10,10,0.2) 0%, rgba(255,0,0,0.2) 100%)",
            border: "1px solid transparent",
            backgroundClip: "padding-box",
        }}>
              {/* Gradient border overlay */}
              <span className="absolute inset-0 rounded-[6000px] pointer-events-none" style={{
            padding: "1px",
          ...
          <div className="flex flex-col items-center gap-8 w-full">
            ...
            <div className="relative w-[279px] h-[74px] bg-[#ffffff0d] rounded-[63.78px] overflow-hidden cursor-pointer">
              ...
              <img className="absolute top-3 left-[217px] w-[50px] h-[50px]" alt="Frame" src="/frame-1321325373-4.svg"/>
            </div>

            {/* Feature bullets */}
            <div className="flex items-center justify-center gap-6 w-full">
              {features.map((feature, index) => (<div key={index} className="inline-flex items-center gap-3 flex-[0_0_auto]">
