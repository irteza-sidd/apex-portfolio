...
const avatarImages = [
    {
        src: "/ellipse-23.png",
        alt: "Ellipse",
        className: "relative w-[99.89px] h-[99.89px] mt-[-20.31px] mb-[-27.08px] ml-[-18.62px]",
    },
    {
        src: "/ellipse-22.png",
        alt: "Ellipse",
        className: "relative w-[99.89px] h-[99.89px] mt-[-20.31px] mb-[-27.08px] ml-[-15px]",
    },
    {
        src: "/ellipse-28.png",
        alt: "Ellipse",
        className: "relative w-[99.89px] h-[99.89px] mt-[-20.31px] mb-[-27.08px] mr-[-28.77px] ml-[-15px]",
    },
];
export const FaqsSection = () => {
    return (<section className="flex w-full items-start justify-center gap-[230px] px-[150px] py-20 bg-[#0c0c0c]">
        ...
        <div className="flex flex-col items-start justify-center gap-[58px] pl-[70px] pr-[140px] py-12 relative self-stretch w-full bg-[#0e0e0e] rounded-2xl overflow-hidden before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-2xl before:[background:linear-gradient(68deg,rgba(45,45,45,0)_0%,rgba(147,147,147,0.4)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none">
          ...
          <div className="items-start gap-3 flex flex-col relative self-stretch w-full">
            <div className="inline-flex items-center relative">
              {avatarImages.map((avatar, index) => (<img key={index} className={avatar.className} alt={avatar.alt} src={avatar.src}/>))}
            </div>
          ...
          <div className="relative w-[195px] h-[55.5px] bg-[#0000001a] rounded-[47.83px] overflow-hidden">
            ...
            <img className="absolute top-[9px] left-[137px] w-[38px] h-[38px]" alt="Frame" src="/frame-1321325373-5.svg"/>
          </div>

          {/* Decorative blurred images */}
          <img className="top-[226px] left-[427px] w-[199px] h-[106px] blur-[2.5px] absolute object-cover" alt="Img" src="/aac51a56b67c91e6cee6283adb3d39cb-2.png"/>
          <img className="top-0 left-0 w-[51px] h-16 blur-[0.5px] absolute object-cover" alt="Img" src="/aac51a56b67c91e6cee6283adb3d39cb-2.png"/>
        </div>
      </div>
      ...
      <div className="flex flex-col items-start px-0 py-6 relative flex-1 self-stretch">
        <Accordion type="single" collapsible className="w-full">
          {faqItems.map((item, index) => (<AccordionItem key={item.id} value={item.id} className={`px-0 py-0 ${index === 0 ? "border-b border-[#282828]" : "border-b border-[#1a1a1a]"} ${index === faqItems.length - 1 ? "border-b-0" : ""}`}>
              <AccordionTrigger className="flex items-center gap-4 px-0 py-9 w-full text-left hover:no-underline [&>svg]:hidden">
                ...
                <img className="w-10 h-10 shrink-0" alt="Left" src="/left.svg"/>
              </AccordionTrigger>
