...
const reasons = [
    {
        ...
        description: "Our UX process ensures products are intuitive, accessible, and conversion-focused.",
    },
    {
        icon: "/frame-2095586102-2.svg",
        title: "Transparent Partnership",
        description: "Clear communication, agile delivery, and full visibility at every stage.",
    },
    {
        icon: "/frame-2095586102-1.svg",
        title: "AI-First Mindset",
        description: "We embed intelligence into products to improve efficiency and decision-making.",
    },
    {
        icon: "/frame-2095586102-3.svg",
        title: "Built for Scale",
        description: "We design secure, cloud-native, and future-ready systems that grow.",
    },
    {
        icon: "/frame-2095586102.svg",
        title: "Full-Stack Expertise",
        description: "From mobile apps and SaaS platforms to AI agents, and digital marketing.",
    },
    {
        icon: "/frame-2095586102-4.svg",
        title: "Results That Matter",
        description: "Every solution we build is focused on driving growth, increasing engagement outcomes.",
    },
];
export const ReasonsToChooseSection = () => {
    return (<section className="w-full bg-[#0c0c0c] flex flex-col items-center px-[120px] py-24">
      {/* Section heading */}
      ...
      <div className="w-full grid grid-cols-3 gap-8 max-w-[1400px]">
        {reasons.map((reason, index) => (<Card key={index} className="flex flex-col items-start justify-between px-8 py-12 bg-[#181818] rounded-3xl overflow-hidden border-none backdrop-blur-[9.5px] backdrop-brightness-100 relative
            ...
            <CardContent className="flex flex-col items-start justify-between w-full h-full p-0 gap-6">
              {/* Icon */}
              <img className="flex-shrink-0" alt={reason.title} src={reason.icon}/>
