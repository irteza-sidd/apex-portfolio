...
const textTestimonials = [
    {
        ...
        quote: "ApexWeb Solutions delivered exactly what we needed clean architecture, scalable code, and a polished user experience. Their AI expertise helped us automate workflows and reduce operational costs significantly.",
    ...
    },
    {
        ...
        quote: "Exceptional engineering quality and communication. The AI agents they developed streamlined our internal operations and customer support dramatically.",
    ...
    },
    {
        ...
        rating: "4.9",
        ratingSecondaryColor: "#909090",
        quote: "They understood our requirements quickly and translated them into a scalable solution. Reliable partner with strong technical expertise.",
...
export const ClientTestimonialsSection = () => {
    return (<section className="flex flex-col w-full items-center justify-center gap-12 px-[150px] py-20 relative bg-neutral-950">
      {/* Header */}
        ...
        <div className="flex flex-col items-start justify-around gap-[60px] p-8 relative flex-shrink-0 w-[245px] bg-[#101010] border-t border-b border-l border-[#1a1a1a]">
          <div className="flex flex-col items-start gap-8 relative flex-1 self-stretch w-full">
            ...
            <div className="items-start gap-3 flex flex-col relative self-stretch w-full">
              {platformRatings.map((platform, index) => (<div key={index} className="flex items-center justify-end gap-2.5 px-3.5 py-1.5 relative self-stretch w-full rounded-[176px] border border-solid border-[#1a1a1a]">
                  <div className="flex items-center gap-2.5 relative flex-1 grow">
                    <img className={`relative ${platform.imgClass}`} alt={platform.alt} src={platform.img}/>
                  </div>
                  <div className="inline-flex items-center gap-1 relative">
                    ...
                    <img className="relative w-[14.83px] h-[14.2px]" alt="Star" src="/star-5.svg"/>
                  </div>
                </div>))}
            </div>
          </div>
        ...
        <div className="relative flex-1 h-[530px] overflow-hidden">
          <div className="flex h-full">
                ...
                <div className="items-start gap-3 flex flex-col relative self-stretch w-full">
                  <div className="flex items-center justify-between relative self-stretch w-full">
                    <div className="relative w-[100px] h-7">
                      <img className="absolute w-[17.16%] h-full top-0 left-0" alt="Logomark" src={textTestimonials[0].logomark}/>
                      <img className="absolute w-[74.65%] h-[56.76%] top-[25.80%] left-[24.84%]" alt="Logotype" src={textTestimonials[0].logotype}/>
                    </div>
                    <div className="inline-flex items-center gap-1 relative">
                      <img className="relative w-[11.03px] h-[10.58px]" alt="Star" src="/star-5-2.svg"/>
            ...
            color: textTestimonials[0].ratingSecondaryColor,
                  ...
                  <img className="relative self-stretch w-full h-px" alt="Line" src="/line-7.svg"/>
                </div>
                {/* Quote */}
                <div className="items-start gap-6 flex flex-col relative self-stretch w-full">
                  <img className="relative w-6 h-[21px]" alt="Image" src="/-.svg"/>
              ...
              <div className="flex items-center gap-5 relative self-stretch w-full">
                <div className="relative w-[54px] h-[54px] rounded-[120px] overflow-hidden">
                  <img className="w-[54px] h-[54px] object-cover" alt="Ellipse" src={textTestimonials[0].avatar}/>
                </div>
                <div className="flex flex-col items-start justify-center gap-1 relative flex-1 self-stretch">
                  ...
                  <div className="relative w-fit font-paragraph-xsmall font-[number:var(--paragraph-xsmall-font-weight)] text-[length:var(--paragraph-xsmall-font-size)] tracking-[var(--paragraph-xsmall-letter-spacing)] leading-[var(--paragraph-xsmall-line-height)] whitespace-nowrap [font-style:var(--paragraph-xsmall-font-style)]" style={{ color: textTestimonials[0].titleColor }}>
            ...
            <div className="flex flex-col w-[405px] h-[530px] flex-shrink-0 items-start justify-around gap-[60px] p-1.5 bg-[#101010] border-t border-b border-l border-[#1a1a1a]">
              <div className="flex flex-col items-center justify-end gap-8 relative flex-1 self-stretch w-full rounded" style={{
            background: `linear-gradient(0deg,rgba(0,0,0,0.2) 0%,rgba(0,0,0,0.2) 100%),linear-gradient(176deg,rgba(0,0,0,0) 0%,rgba(0,0,0,0.7) 100%),url(${imageTestimonials[0].bgImage}) 50% 50% / cover`,
                ...
                <img className="relative w-full flex-1 object-contain" alt="Frame" src={imageTestimonials[0].frameSvg}/>
                <div className="flex items-center gap-5 px-8 py-7 relative self-stretch w-full">
                  <div className="relative w-[54px] h-[54px] rounded-[120px] overflow-hidden">
                    <img className="w-[54px] h-[54px] object-cover" alt="Ellipse" src={imageTestimonials[0].avatar}/>
                  </div>
                ...
                <div className="items-start gap-3 flex flex-col relative self-stretch w-full">
                  <div className="flex items-center justify-between relative self-stretch w-full">
                    <div className="relative w-[100px] h-[27px]">
                      <img className="absolute w-[24.86%] top-[4.17%] left-0 h-[91.67%]" alt="Logomark" src={textTestimonials[1].logomark}/>
                      <img className="absolute w-[68.63%] h-[55.60%] top-[27.64%] left-[31.14%]" alt="Logotype" src={textTestimonials[1].logotype}/>
                    </div>
                    <div className="inline-flex items-center gap-1 relative">
                      <img className="relative w-[11.03px] h-[10.58px]" alt="Star" src="/star-5-2.svg"/>
                      <div className="mt-[-0.50px] [font-family:'Inter_Display-Regular',Helvetica] font-normal text-transparent text-xs tracking-[0] leading-[normal] relative w-fit">
            ...
            color: textTestimonials[1].ratingSecondaryColor,
              ...
              <div className="flex items-center gap-5 relative self-stretch w-full">
                <div className="relative w-[54px] h-[54px] rounded-[120px] overflow-hidden">
                  <img className="w-[54px] h-[54px] object-cover" alt="Ellipse" src={textTestimonials[1].avatar}/>
                </div>
                <div className="flex flex-col items-start justify-center gap-1 relative flex-1 self-stretch">
                  <div className="relative self-stretch [font-family:'Inter_Display-SemiBold',Helvetica] font-semibold text-[#ffffff] text-base tracking-[0] leading-[normal]">
                    {textTestimonials[1].name}
                  </div>
                  <div className="relative w-fit font-paragraph-xsmall font-[number:var(--paragraph-xsmall-font-weight)] text-[length:var(--paragraph-xsmall-font-size)] tracking-[var(--paragraph-xsmall-letter-spacing)] leading-[var(--paragraph-xsmall-line-height)] whitespace-nowrap [font-style:var(--paragraph-xsmall-font-style)]" style={{ color: textTestimonials[1].titleColor }}>
            ...
            background: `linear-gradient(0deg,rgba(0,0,0,0.2) 0%,rgba(0,0,0,0.2) 100%),linear-gradient(176deg,rgba(0,0,0,0) 0%,rgba(0,0,0,0.7) 100%),url(${imageTestimonials[1].bgImage}) 50% 50% / cover`,
                ...
                <img className="relative w-full flex-1 object-contain" alt="Frame" src={imageTestimonials[1].frameSvg}/>
                <div className="flex items-center gap-5 px-8 py-7 relative self-stretch w-full">
                  <div className="relative w-[54px] h-[54px] rounded-[120px] overflow-hidden">
                    <img className="w-[54px] h-[54px] object-cover" alt="Ellipse" src={imageTestimonials[1].avatar}/>
                  </div>
                  <div className="flex flex-col items-start justify-center gap-1 flex-1 grow relative">
                    <div className="relative self-stretch mt-[-1.00px] [font-family:'Inter_Display-SemiBold',Helvetica] font-semibold text-[#ffffff] text-base tracking-[-0.32px] leading-[normal]">
                ...
                <div className="items-start gap-3 flex flex-col relative self-stretch w-full">
                  <div className="flex items-center justify-between relative self-stretch w-full">
                    <div className="relative w-[100px] h-[28.74px]">
                      <img className="absolute w-[22.75%] top-0 left-0 h-[91.67%]" alt="Logomark" src={textTestimonials[2].logomark}/>
                      <img className="absolute w-[69.48%] h-[60.52%] top-[20%] left-[25%]" alt="Logotype" src={textTestimonials[2].logotype}/>
                    </div>
                    <div className="inline-flex items-center gap-1 relative">
                      <img className="relative w-[11.03px] h-[10.58px]" alt="Star" src="/star-5-2.svg"/>
                      <div className="mt-[-0.50px] [font-family:'Inter_Display-Regular',Helvetica] font-normal text-transparent text-xs tracking-[0] leading-[normal] relative w-fit">
            ...
            color: textTestimonials[2].ratingSecondaryColor,
              ...
              <div className="flex items-center gap-5 relative self-stretch w-full">
                <div className="relative w-[54px] h-[54px] rounded-[120px] overflow-hidden">
                  <img className="w-[54px] h-[54px] object-cover" alt="Ellipse" src={textTestimonials[2].avatar}/>
                </div>
                <div className="flex flex-col items-start justify-center gap-1 relative flex-1 self-stretch">
                  <div className="relative self-stretch [font-family:'Inter_Display-SemiBold',Helvetica] font-semibold text-[#ffffff] text-base tracking-[0] leading-[normal]">
                    {textTestimonials[2].name}
                  </div>
                  <div className="relative w-fit font-paragraph-xsmall font-[number:var(--paragraph-xsmall-font-weight)] text-[length:var(--paragraph-xsmall-font-size)] tracking-[var(--paragraph-xsmall-letter-spacing)] leading-[var(--paragraph-xsmall-line-height)] whitespace-nowrap [font-style:var(--paragraph-xsmall-font-style)]" style={{ color: textTestimonials[2].titleColor }}>
      ...
      {/* Navigation arrows */}
      <img className="absolute top-[558px] right-[150px] w-9 h-9" alt="Right" src="/right-1.svg"/>
      <img className="absolute top-[558px] left-[150px] w-9 h-9" alt="Left" src="/right.svg"/>

      {/* Bottom decorative frame */}
      <img className="relative self-stretch w-full" alt="Frame" src="/frame-2095586047.svg"/>
    </section>);
};
