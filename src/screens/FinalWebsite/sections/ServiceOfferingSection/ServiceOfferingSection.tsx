...
export const ServiceOfferingSection = (): JSX.Element => {
  return (
    <section className="flex flex-col w-full items-center gap-10 px-[150px] py-[60px] bg-[#0c0c0c]">
      {/* Header */}
      ...
      <div className="flex flex-col items-center gap-6 self-stretch w-full">
        ...
        <div className="flex items-center gap-5 px-0 py-5 self-stretch w-full">
          {services.map((service) => (
            <Card
              key={service.number}
              className="flex flex-col h-[416px] items-start justify-between p-8 flex-1 bg-neutral-950 rounded-xl overflow-hidden border border-solid border-[#383838]"
            >
