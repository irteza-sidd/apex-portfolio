...
export const HeroShowcaseSection = (): JSX.Element => {
  return (
    <div className="relative w-full min-h-[935px] bg-black overflow-hidden">
      ...
      <div className="absolute top-[calc(50%_-_346px)] right-[-200px] w-[1415px] h-[796px] flex pointer-events-none">
        <img
          ...
          alt="Final loop red shade"
          src="/final-loop---red-shade.png"
        />
      </div>
      ...
      <div className="flex flex-col w-[762px] items-start gap-[60px] absolute top-[236px] left-[150px] z-10">
        ...
        <div className="inline-flex items-center gap-3">
          ...
          <div className="relative w-[279px] h-[74px] bg-[#a1a1a142] rounded-[63.78px] overflow-hidden cursor-pointer">
            ...
            <img
              className="absolute top-3 left-[213px] w-[50px] h-[50px]"
              alt="Frame"
              src="/frame-1321325373.svg"
            />
          </div>
          ...
          <Button
            variant="ghost"
            className="h-auto inline-flex items-center justify-center gap-2 px-3 py-[18px] rounded-[60px] [font-family:'Inter_Display-Medium',Helvetica] font-medium text-[#ffffff] text-lg tracking-[-0.18px] leading-normal hover:bg-transparent hover:text-[#ffffff]"
          >
            See Our Work
          </Button>
        </div>
